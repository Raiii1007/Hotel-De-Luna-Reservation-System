...
if(isset($_POST['submit'])){
   ...
   $select_admins = $conn->prepare("SELECT * FROM `admins` WHERE admin_name = ? AND password = ? LIMIT 1");
...
<section class="form-container" style="min-height: 100vh;">
   ...
   <form action="" method="POST">
      ...
      <input type="text" name="admin_name" placeholder="enter username" maxlength="20" class="box" required oninput="this.value = this.value.replace(/\s/g, '')">
