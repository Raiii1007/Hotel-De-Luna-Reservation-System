...
<section class="grid">
   ...
   <div class="box">
      ...
      <p>guest_name : <span><?= $fetch_bookings['guest_name']; ?></span></p>
      <p>guest_email : <span><?= $fetch_bookings['guest_email']; ?></span></p>
      <p>guest_number : <span><?= $fetch_bookings['guest_number']; ?></span></p>
