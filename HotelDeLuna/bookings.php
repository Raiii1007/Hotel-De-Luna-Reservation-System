...
<section class="bookings">
   ...
   ?>
   <div class="box">
      <p>guest_name : <span><?= $fetch_booking['guest_name']; ?></span></p>
      <p>guest_email : <span><?= $fetch_booking['guest_email']; ?></span></p>
      <p>guest_number : <span><?= $fetch_booking['guest_number']; ?></span></p>
