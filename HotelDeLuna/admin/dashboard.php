...
<div class="box">
   ...
   <div class="box">
    <?php
    $select_audit_log = $conn->prepare("SELECT COUNT(*) as total_logs FROM `audit_log`");
    $select_audit_log->execute();
    $count_audit_logs = $select_audit_log->fetchColumn();
    ?>
    <h3><?= $count_audit_logs; ?></h3>
    <p>total audit logs</p>
    <a href="audit_logs.php" class="btn">view audit logs</a>
</div>
